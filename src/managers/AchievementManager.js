...
export const ACHIEVEMENT_LIST = [
  {
    ...
    descriptionEn: 'Win your first run.',
    emoji: '🏆',
  },
  {
    id: 'warrior_win',
    name: 'Guerriero Invincibile',
    nameEn: 'Invincible Warrior',
    description: 'Vinci una run con il Guerriero.',
    descriptionEn: 'Win a run with the Warrior.',
    emoji: '⚔️',
  },
  {
    id: 'rogue_win',
    name: 'Ombra nella Notte',
    nameEn: 'Shadow in the Night',
    description: 'Vinci una run con il Ladro.',
    descriptionEn: 'Win a run with the Rogue.',
    emoji: '🗡️',
  },
  {
    id: 'alchemist_win',
    name: 'Grande Alchimista',
    nameEn: 'Great Alchemist',
    description: 'Vinci una run con l\'Alchimista.',
    descriptionEn: 'Win a run with the Alchemist.',
    emoji: '⚗️',
  },
  {
    id: 'no_damage',
    ...
    descriptionEn: 'Complete a combat without taking damage.',
    emoji: '🛡️',
  },
  {
    id: 'big_deck',
    ...
    descriptionEn: 'Reach 20 cards in your deck.',
    emoji: '📚',
  },
  {
    id: 'rich',
    ...
    descriptionEn: 'Accumulate 150 gold in a run.',
    emoji: '💰',
  },
  {
    id: 'speed_run',
    ...
    descriptionEn: 'Complete a run visiting less than 12 nodes.',
    emoji: '⚡',
  },
];
